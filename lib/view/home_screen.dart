      ...
      body: Column(
        children: [
            ...
            Container(
              ...
              child: Stack(
                children: [
                  // Background image - dynamic based on next prayer
                  Obx(() {
                    String imagePath = 'images/fajr_img.png'; // default
                    
                    if (timerController.isInitialized.value) {
                      final nextPrayer = timerController.nextPrayerName.value.toLowerCase();
                      switch (nextPrayer) {
                        case 'fajr':
                          imagePath = 'images/fajr_img.png';
                          break;
                        case 'zuhr':
                          imagePath = 'images/zuhr_img.png';
                          break;
                        case 'asr':
                          imagePath = 'images/asr_img.png';
                          break;
                        case 'maghrib':
                          imagePath = 'images/maghrib_img.png';
                          break;
                        case 'isha':
                          imagePath = 'images/fajr_img.png'; // Isha uses fajr image
                          break;
                        default:
                          imagePath = 'images/fajr_img.png';
                      }
                    } else {
                      // If timer not initialized, use current prayer
                      final currentPrayer = prayerController.getCurrentPrayerName().toLowerCase();
                    ...
                    return ClipRRect(
                      ...
                      child: Image.asset(
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          // Fallback to fajr image if image not found
                          return Image.asset(
                            'images/fajr_img.png',
                            width: double.infinity,
                            height: double.infinity,
